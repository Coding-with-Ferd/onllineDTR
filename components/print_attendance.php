...
<body>
    ...
    <div class="preview-page">
        <div class="preview-actions no-print">
            <a href="../pages/attendance.php?from=<?= urlencode($_GET['from'] ?? '') ?>&to=<?= urlencode($_GET['to'] ?? '') ?>" class="btn-back-preview">
                Back
            </a>
                        ...
                        <input
                            ...
                            value="<?=
                                    (!empty($_GET['from']) && !empty($_GET['to']))
                                        ? htmlspecialchars(strtoupper(date('F d, Y', strtotime($_GET['from'])) . ' - ' . date('F d, Y', strtotime($_GET['to']))))
                                        : 'ALL RECORDS'
                                    ?>"
                            class="print-input">
                    </td>
